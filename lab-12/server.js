...
// POST: Handle candidate form submission with validation
...
<head>
  ...
  <style>
    .candidate-box { border: 1px solid #ccc; margin: 10px; padding: 10px; border-radius: 5px; background: #f9f9f9; }
...
// GET: Display single candidate by ID
